...
public class SyncTokenTask {
	...
	@Scheduled(initialDelay=0,fixedDelay=1000*60*90)//cron = "*/10 * * * * ?"
	// "1/5 * * * * ?"
	public void schedulSyncToken() {
		System.out.println(token = getNewToken());
	}
	...
	public Token getNewToken() {
		...
		return template.getForEntity(sb.toString(), Token.class, new Object())
				.getBody();
		// 字段 允许值 允许的特殊字符
		// 秒 0-59 , - * /
		// 分 0-59 , - * /
